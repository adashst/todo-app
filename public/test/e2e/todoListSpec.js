...
(function () {
    ...
    describe('todos list page', function () {
        ...
        it('should show at detail link', function () {
            var detailButton = browser.element(by.className('search'));
            detailButton.click();
        ...
        it('should remove the first todo', function () {
            expect(todoList.count()).toEqual(2);
            todoList.first().then(function (elm) {
                elm.findElement(by.className('trash')).then(function (a) {
                    expect(a.getText()).toEqual('write a protractor test');
                    a.click();
                });
            });
            expect(todoList.count()).toEqual(1);
        ...
        it('should navigate to the /detail page when clicking', function () {
            ...
            expect(browser.getCurrentUrl()).toMatch(/\/todos\/go%20to%20lunch/);
        });
